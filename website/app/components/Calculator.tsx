    ...
    <section id="calculator" className="py-24 px-6 relative">
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="glass-card rounded-2xl p-6 mb-6 glow-card-blue">
          <div className="text-xs text-[#6B7A93] uppercase tracking-widest mb-4 text-center">Speed Comparison</div>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-[#9FB0C7] flex items-center gap-2">
                  <span className="text-base">⌨️</span> Typing speed
                </span>
                <span className="text-sm font-bold text-[#6B7A93]">40 WPM</span>
              </div>
              <div className="h-3 rounded-full bg-white/5 overflow-hidden">
                <div
                  className="h-full rounded-full bg-[#6B7A93]/60 transition-all duration-700"
          ...
          <div className="mt-4 text-center">
            ...
            <span className="text-[#6B7A93] text-sm ml-2">with your voice</span>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-8">
              <div>
                ...
                />
                <div className="flex justify-between text-xs text-[#6B7A93] mt-1">
                  <span>1h</span>
                  <span>10h</span>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-white/5">
                <div className="flex items-start gap-2 text-sm text-[#6B7A93]">
            ...
            <div className="space-y-4">
              <div className="text-center mb-2">
                <div className="text-xs text-[#6B7A93] uppercase tracking-widest">Your time savings with voice</div>
              </div>

              {/* Weekly — hero stat */}
              <div className="glass-card rounded-xl p-5 text-center border border-green-500/20 bg-green-500/5">
                <div className="text-xs text-[#6B7A93] uppercase tracking-widest mb-1">Weekly hours saved</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="glass-card rounded-xl p-4 text-center">
                  ...
                  <div className="text-xs text-[#6B7A93] mt-1">per month</div>
                </div>
                <div className="glass-card rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-cyan-400">{Math.round(yearlySaved)}h</div>
                  <div className="text-xs text-[#6B7A93] mt-1">per year</div>
                </div>
              </div>
              ...
              <div className="glass-card glow-card-green rounded-xl p-5 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-xs text-[#6B7A93] uppercase tracking-widest mb-1">Value of time saved</div>
                  ...
                  <div className="mt-3 text-xs text-[#6B7A93] bg-white/5 rounded-lg px-3 py-1.5 inline-block">
